...
#data "aws_ssm_parameter" "concourse_github_client_id" {
#  name = var.secrets.admin.concourse_github_client_id
#}

#data "aws_ssm_parameter" "concourse_github_client_secret" {
#  name = var.secrets.admin.concourse_github_client_secret
#}
