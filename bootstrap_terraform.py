...
def main():
    ...
    try:
        ...
        concourse_secret = secrets_manager.get_secret_value(SecretId="/concourse/dataworks/dataworks")
    ...
    config_data['concourse_username'] = json.loads(dataworks_secret['SecretBinary'])["concourse_user"]
    config_data['concourse_password'] = json.loads(dataworks_secret['SecretBinary'])["concourse_password"]
    config_data['database_username'] = json.loads(dataworks_secret['SecretBinary'])["database_user"]
    config_data['database_password'] = json.loads(dataworks_secret['SecretBinary'])["database_password"]
